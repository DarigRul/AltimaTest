...
{
    public partial class CatalogoRoles : OfficeForm
    {
        ...
        {
            var ntm = new CatalogoRolesAM();
            ntm.refrescar += () => CatalogoRoles_Load(this, EventArgs.Empty);
            ntm.movimiento = CatalogoRolesAM.Movimiento.agregar;
            ntm.ShowDialog();
        }
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            var cr = new CatalogoRolesAM();
            cr.rolModificar = rolModificar;
            cr.movimiento = CatalogoRolesAM.Movimiento.modificar;
