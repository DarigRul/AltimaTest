...
namespace ALTIMA_ERP_2022
{
    public partial class Main : Form
    {
        ...
        private void btnCatalogoY_Click(object sender, EventArgs e)
        {
            Form frm = this.MdiChildren.Cast<Form>().FirstOrDefault(x => x is CatalogoY.CatalogoY);
            if (frm != null)
            {
                frm.BringToFront();
                return;
